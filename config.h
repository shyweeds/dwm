...
static const char *fonts[]          = { "JetBrains Mono Nerd Font:size=16", "Noto Sans CJK SC:size=14" };
...
// my pawal16 define the colorscheme 
...
static const Key keys[] = {
  ...
  { ShiftMask,                    XK_F2,     spawn,          SHCMD("${HOME}/dwm/scripts/screenshotsel.sh") },
	...
	{ MODKEY,                       XK_d,      spawn,          SHCMD("${HOME}/dwm/scripts/dmenucmd.sh") },
